  ...
  return (
    <section className="relative">
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        {/* Blurred shape */}
        <div
          className="-z-9 rotate-270 pointer-events-none absolute right-0 top-0 -ml-16 -mt-24 opacity-70 blur-2xl"
          aria-hidden="true"
        >
        ...
        <div className="pb-12 pt-16 md:pb-20 md:pt-32">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              We&apos;re committed to providing a real impact on your business
              with our delivery. <br/>When you partner with us, you can expect:
            </p>
          </div>
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex bg-gradient-to-r from-orange-500 to-orange-200 bg-clip-text pb-6 font-medium text-transparent">
                  Cloud Architectural Infrastructures
                </div>
              </div>
              <div className="mb-2 grid gap-8 md:grid-cols-3 md:gap-12">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Creation of cloud infrastructure from the ground up, setting
                    up servers, databases, and storage solutions, and
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Transferring a company&apos;s digital assets, services, and
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Day-to-day operational management of a company&apos;s cloud
                    infrastructure, ensuring high availability, security, and
                    optimal performance.
                  </p>
                </div>
              </div>
            ...
            <div className="py-8">
              ...
              <div className="mb-2 grid gap-8 md:grid-cols-3 md:gap-12">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Creating pipelines for importing, validating, cleaning, and
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Converting raw data into a more suitable format for
                    analysis, often by aggregating, summarizing, or creating
                    derived values.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Managing the infrastructure that stores data and enables
                    efficient query and retrieval, often involving data
                    warehousing and data lake solutions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="py-8">
              ...
              <div className="mb-2 grid gap-8 md:grid-cols-3 md:gap-12">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Using statistical forecasting models and machine learning to
                    make predictions about future events or behaviors based on
                    historical data.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Analyzing past data to understand trends, patterns, and
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Using optimization algorithms and simulation to suggest
                    optimal actions to take, given a set of parameters and
                    constraints.
                  </p>
                </div>
              </div>
