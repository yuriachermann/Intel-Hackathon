...
const navigation = {
  solutions: [
    ...
    // { name: "Application", href: "/solutions/application" },
    // { name: "Pricing", href: "/solutions/prices" },
    // { name: "Simulation", href: "/solutions/simulation" },
  ],
  support: [
    // { name: "Press", href: "/support/press" },
  ...
  legal: [
    ...
    // { name: "Statement", href: "/legal/statement" },
  ],
  social: [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/way-co/",
  ...
  return (
    <footer className="bg-gray-900" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mt-8 flex gap-6 border-t border-gray-700 pt-8 md:items-center md:justify-between">
          ...
          <div className="flex">
            <Image
              src="/logo-simple2.png"
              alt="Logo"
              width={32}
              height={32}
              className="h-10 w-10"
            />
            <p className="order-1 ml-6 self-center text-base text-gray-400 md:mt-0">
              &copy;{t("rights_reserved")}
            </p>
          </div>
        </div>
      </div>
