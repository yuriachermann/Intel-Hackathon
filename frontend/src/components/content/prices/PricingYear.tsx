...
function PricingYear() {
  return (
    <section className="relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-18 border-gray-800">
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none ">
            ...
            <div className="relative flex flex-col h-full p-6" data-aos="zoom-out">
              <div className="mb-6">
                ...
                <div className="font-uncut-sans inline-flex items-baseline mb-2">
                  ...
                  <span className="text-4xl font-bold leading-7">588</span>
            ...
            <div className="relative flex flex-col h-full p-6 bg-gray-800" data-aos="zoom-out" data-aos-delay="100">
              ...
              <div className="mb-6">
                ...
                <div className="font-uncut-sans inline-flex items-baseline mb-2">
                  <span className="text-3xl font-medium text-gray-400">$</span>
                  <span className="text-4xl font-bold leading-7">948</span>
                  <span className="font-medium text-gray-400">/year</span>
                </div>
                <div className="text-gray-400 mb-6">For teams building apps for many public &amp; private users.</div>
                <Link className="btn-sm text-white bg-gradient-to-t from-blue-600 to-blue-400 hover:to-blue-500 w-full shadow-lg group" href="#0">
            ...
            <div className="relative flex flex-col h-full p-6" data-aos="zoom-out" data-aos-delay="200">
              <div className="mb-6">
                ...
                <div className="font-uncut-sans inline-flex items-baseline mb-2">
                  <span className="text-3xl font-medium text-gray-400">$</span>
                  <span className="text-4xl font-bold leading-7">1548</span>
                  <span className="font-medium text-gray-400">/year</span>
                </div>
                <div className="text-gray-400 mb-6">For teams building apps for many public &amp; private users.</div>
                <Link className="btn-sm text-white bg-gradient-to-t from-blue-600 to-blue-400 hover:to-blue-500 w-full shadow-lg group" href="#0">
