      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="text-center pb-12 md:pb-20">
            <h2 className="h2 font-uncut-sans" data-aos="zoom-out">{t('focus_on_solving_bigger_problems')}</h2>
          </div>
          <div className="pb-16" data-aos="zoom-out">
            <Image src='/features.svg' width="1104" height="512" alt="Features" />
          </div>
          {/* Items */}
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="flex flex-col items-center" data-aos="zoom-out">
                ...
                <svg width="56" height="56" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                  <defs>
                    <radialGradient cx="50%" cy="89.845%" fx="50%" fy="89.845%" r="89.85%" id="icon1-b">
                      ...
                      <stop stopColor="#449E86" stopOpacity=".876" offset="100%" />
                    </radialGradient>
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">{t('feature_1')}</h4>
              <p className="text-lg text-gray-400 text-center">{t('feature_1_description')}</p>
            </div>
            {/* 2nd item */}
            <div className="flex flex-col items-center" data-aos="zoom-out" data-aos-delay="200">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">{t('feature_2')}</h4>
              <p className="text-lg text-gray-400 text-center">{t('feature_2_description')}</p>
            </div>
            {/* 3rd item */}
            <div className="flex flex-col items-center" data-aos="zoom-out" data-aos-delay="400">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">{t('feature_3')}</h4>
              <p className="text-lg text-gray-400 text-center">{t('feature_3_description')}</p>
            </div>
          </div>
        </div>
      </div>
