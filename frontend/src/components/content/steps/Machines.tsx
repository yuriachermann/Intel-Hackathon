...
function Machines(){
  return (
    <div>
      <h2 className="mt-1 pb-3 text-xl text-white md:text-2xl lg:text-3xl">
        Machines
      </h2>
      <h3 className="pb-5 text-lg font-medium text-gray-500 dark:text-gray-400 md:text-xl lg:text-2xl">
