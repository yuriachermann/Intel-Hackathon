...
class LoadImages:
    ...
    def __init__(
        self, image, img_size=640, stride=32, auto=True, transforms=None, vid_stride=1
    ):
        self.img_size = img_size
        self.stride = stride
        self.files = [image]
    ...
    def __next__(self):
        ...
        self.count += 1
        im0 = image  # BGR
        assert im0 is not None, f"Image Not Found {image}"
        s = f"image {self.count} {image}: "
